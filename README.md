...
## SDLC Overview
- **Planning:** Defined product vision, created backlog, set up Kanban board.  
- **Design:** Wireframes and mockups for booking interface.  
- **Development:** Prototype implementation using Agile sprints.  
- **Testing/Evaluation:** User feedback collected and improvements documented.  
